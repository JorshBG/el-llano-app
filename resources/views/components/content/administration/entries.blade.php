...
<x-headers.menu-default :title="$plural" :buttontext="$single">
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            ...
            <input name="batch_name" type="text" class="form-control form_input" id="form_entry-name" autofocus required />
        </div>
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            <span class="input-group-text" id="basic-addon1">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-5-circle-fill" viewBox="0 0 16 16">
                    <path
            ...
            <input name="amount" type="number" pattern="[0-9]+\.?[0-9]*" class="form-control form_input" id="form_entry-amount"
                autofocus required />
        </div>
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            ...
            <input name="expiration_date" type="date" class="form-control form_input" id="form_entry-expiration" autofocus required />
        </div>
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            ...
            <input name="purchase_date" type="date" class="form-control form_input" id="form_entry-buy" autofocus required />
        </div>
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            ...
            <input name="manufacturing_date" type="date" class="form-control form_input" id="form_entry-manufactur" autofocus required />
        </div>
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            ...
            <input name="cost_per_product" type="number" pattern="[0-9]+\.?[0-9]*" class="form-control form_input" id="form_entry-costs"
                autofocus required />
        </div>
    </div>
