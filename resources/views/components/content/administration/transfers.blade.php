...
<x-headers.menu-default :title="$plural" :buttontext="$single">
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            ...
            <input type="date" class="form-control form_input" id="form_outputs-close" autofocus required />
        </div>
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            <span class="input-group-text" id="basic-addon1">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-6-circle-fill" viewBox="0 0 16 16">
                    <path
            ...
            <input type="number" pattern="[0-9]+" class="form-control form_input" id="form_outputs-total" autofocus
                required />
        </div>
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            ...
            <select class="form-select form_input" id="form_outputs-status" aria-label="Store origin select">
            </select>
        </div>
    </div>
