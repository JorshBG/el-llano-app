...
<x-partials.menu-bar parent="Categorías" :child="$plural" :username="$username"/>

<x-headers.menu-default :title="$plural" :buttontext="$single" route="/category/create" method="post">
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control form_input" placeholder="Tabletas" id="form_categorie-name"
