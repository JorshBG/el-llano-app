...
<x-headers.menu-default :title="$plural" :buttontext="$single">
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control form_input" placeholder="Almacen general" id="form_store-name"
    ...
    <div class="form-group mb-4">
        ...
        <textarea name="description" class="form-control form_input" placeholder="Descríbelo..." id="form_store-description" autofocus required></textarea>
    </div>
