...
<x-partials.menu-bar parent="Presentación" :child="$plural" />

<x-headers.menu-default :title="$plural" :buttontext="$single" route="/presentation/create" method="post">

    <!-- presentationS NAME -->
    <div class="form-group mb-4">
        <label for="form_presentation-name">Nombre</label>
        <div class="input-group">
            ...
            <input type="text" class="form-control form_input" placeholder="Tabletas" id="form_presentation-name"
